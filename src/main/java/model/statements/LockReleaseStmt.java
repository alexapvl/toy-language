...
public class LockReleaseStmt implements IStmt {
  private String var;

  public LockReleaseStmt(String var) {
    this.var = var;
  }
  ...
  public PrgState execute(PrgState state) throws AppException {
    ...
    } else if (lockTable.lookup(foundIndex) == (Integer) state.getId()) { // can be released
  ...
  public IStmt deepCopy() {
    return new LockReleaseStmt(this.var);
  }
